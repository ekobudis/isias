...
class Paginator{
	...
	public function __construct($total=0,$mid_range=7,$ipp_array=array(25,50,100,"All")) {
		...
		if($this->num_pages > 10) {
			$this->return = ($this->current_page > 1 And $this->total_items >= 10) ? "<a class=\"pagination\" href=\"$_SERVER[PHP_SELF]?page=".($this->current_page-1)."&ipp=$this->items_per_page$this->querystring\">Previous</a> ":"<span class=\"disabled\" href=\"#\">Previous</span> ";
			...
			for($i=1;$i<=$this->num_pages;$i++) {
				...
				if($i==1 Or $i==$this->num_pages Or in_array($i,$this->range)) $this->return .= ($i == $this->current_page And $this->items_per_page != "All") ? "<li><a title=\"Go to page $i of $this->num_pages\" class=\"active\" href=\"#\">$i</a></li> \n":"<li><a title=\"Go to page $i of $this->num_pages\" href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> \n";
				if($this->range[$this->mid_range-1] < $this->num_pages-1 And $i == $this->range[$this->mid_range-1]) $this->return .= " ... ";
			}
			$this->return .= (($this->current_page < $this->num_pages And $this->total_items >= 10) And ($this->items_per_page != "All") And $this->current_page > 0) ? "<a href=\"$_SERVER[PHP_SELF]?page=".($this->current_page+1)."&ipp=$this->items_per_page$this->querystring\">Next</a>\n":"<span class=\"disabled\" href=\"#\">Next</span>\n";
			$this->return .= ($this->items_per_page == "All") ? "<li><a class=\"active\" href=\"#\">All</a></li> \n":"<li><a href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\">All</a></li> \n";
		} else	{
			for($i=1;$i<=$this->num_pages;$i++) {
				$this->return .= ($i == $this->current_page) ? "<li><a class=\"active\" href=\"#\">$i</a></li> ":"<li><a href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
			}
	...
	public function display_items_per_page() {
		...
		return "<span class=\"pagination\">Items per page:</span><select class=\"pagination\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&amp;ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select>\n";
	}
	public function display_jump_menu() {
		...
		return "<span class=\"pagination\">Page:</span><select class=\"pagination\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&amp;ipp=$this->items_per_page$this->querystring';return false\">$option</select>\n";
	}

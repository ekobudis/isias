...
include_once '/Applications/MAMP/htdocs/isias/classes/class.NilaiTest.php';
...
if ($num_rows>0){
    ...
    if(isset($_POST['cari'])){
        $cari = $_POST['cari'];
        $stmt = $nilai->GetListNilaiTest($pages->limit_start, $pages->limit_end);
    }
    else{
        $stmt = $nilai->GetListNilaiTest($pages->limit_start, $pages->limit_end);
    }
...
<div class="container">
    <div class="row">
        <a href="#myModal" role="button" class="btn btn-info btn-plus" data-toggle="modal" data-target="#add-Data">Entry Nilai Test Baru</a>
    </div>
</div>
<!-- Table Content -->
</br>
        ...
        <div class="table-responsive">
            <table class="table no-margin">
                ...
                <tr>
                    ...
                    <th style="width:220px">Nama Pendaftar</th>
                    <th style="width:320px">Jenis Test</th>

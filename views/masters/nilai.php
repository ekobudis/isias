...
<div class='box box-info'>
    <div class="box-body">
        <div class="table-responsive">
            <div class="row col-md-4"> <!-- Filter Record by Kelas or Other -->

            </div>
            <table class="table no-margin col-md-8">
                <thead>
                <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Form Input Nilai</h4>
            </div>
                ...
                <div class="row">
                    <form class="form-horizontal" role="form" method="post" action="classes/crud_kategori.php?p=add">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">NIM/NIS</label>
                                <div class="input-group col-md-8">

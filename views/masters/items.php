...
include_once '/Applications/MAMP/htdocs/isias/classes/class.Items.php';
...
if ($num_rows>0){
    ...
    if(isset($_POST['cari'])){
        $cari = $_POST['cari'];
        $stmt = $data->GetListItems($pages->limit_start, $pages->limit_end);
    }
    else{
        $stmt = $data->GetListItems($pages->limit_start, $pages->limit_end);
    }
                    ...
                    <table class='table no-margin'>
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                            ...
                            echo"<td style='text-align:center;width:160px'>
                                    <a class='btn btn-xs btn-warning' href='?m=033&p=change&id={$id}'><i class='glyphicon glyphicon-pencil'></i></a>
                                    <a></a>
                        ...
                        <div class='col-md-12'>
                            ...
                            <div class='form-group'>
                                <div class='col-md-12'>
                                    ...
                                    <a href='?m=033' class='btn btn-md btn-success'><i class='glyphicon glyphicon-backward'></i> &nbsp; Kembali</a>
                                </div>
                            </div>
                        </div>
                    </form>
